...
class APIService {
  ...
  static Future<DataResponse> fetchPowerActive(String phase) async {
    final response = await http.get(Uri.parse("${dotenv.env['DATABASE_URL2']!}/exec?query=SELECT%20ts%2C%20power_active%20FROM%20phase%20WHERE%20phase~'$phase'%20ORDER%20BY%20ts%20DESC&nm=true&limit=40"));
